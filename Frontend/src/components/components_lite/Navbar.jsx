...
<div className="flex items-center gap-2">
  ...
  <div className="px-1 py-1 bg-[#0803a5] flex items-center justify-center shadow-md">
  ...
  <h1 className="text-4xl font-extrabold tracking-tight">
    <span className="text-[#0803a5]">Portal</span>
  </h1>
</div>

        <div className="flex items-center gap-10 font-mono font-bold">
